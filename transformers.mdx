...
\> A Transformer might predict that an article is “fake news,”  

\> but without XAI, we don’t know if it’s because of a misleading headline, a biased source, or specific word choices.
